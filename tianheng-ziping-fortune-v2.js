...
function deps(){var p=root.TianhengZipingPattern,f=root.TianhengZipingFlow,q=root.TianhengZipingQi,o=root.TianhengZipingOfficerKill,c=root.TianhengZipingFortuneCombinations;if(!p||!f||!q||!o||!c)throw Error('需先載入 pattern、flow、qi、officer-kill 與 fortune-combinations 模組');return {p:p,f:f,q:q,o:o,c:c};}
...
function analyze(pillars,fortune,options){valid(pillars,fortune);var d=deps(),pt=d.p.analyzeFortune(pillars,fortune,options||{}),ft=d.f.analyzeFortune(pillars,fortune),qt=d.q.analyzeFortune(pillars,fortune),ot=d.o.analyzeFortune(pillars,fortune),ct=d.c.analyze(pillars,fortune),qb=qt.before,qa=qt.after,rawTypes=pt.transition.types.slice(),types=rawTypes.slice(),qiEvent=null,conflicts=[];
