...
assert('今日運勢入口保留',()=>home.includes('id="dailyEntry"')&&home.includes('今 日 運 勢'));
assert('雙人合度入口保留',()=>home.includes('href="compat.html"')&&home.includes('雙 人 合 度'));
assert('六爻問事入口保留',()=>home.includes('tianheng-wenshi-qa-v1.html')&&home.includes('六 爻 問 事'));
assert('梅花易數入口已加入主頁',()=>home.includes('./tianheng-meihua-qa-v1.html?v=20260901-meihua-home')&&home.includes('梅 花 易 數'));
assert('主頁階段標示包含梅花公開驗證',()=>home.includes('六爻問事與梅花易數開放驗證'));
